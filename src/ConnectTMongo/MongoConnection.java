...
public class MongoConnection {
    ...
    public static MongoDatabase connectToMongoDB(){
        ...
        mongoDatabase = mongoClient.getDatabase("MyMom");
    ...
    public static String insertToMongoDB(User user){
        ...
        MongoCollection<Document> collection = mongoDatabase.getCollection("Siddique");
    ...
    public static void main(String[] args) throws Exception {
        insertToMongoDB(new User("Mom","101","12/02/1960"));
